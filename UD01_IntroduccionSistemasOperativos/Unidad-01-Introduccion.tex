...
\label{sec:orgd4ffb43}

\subsection{Introducción}
\label{sec:org08bee54}
...
\label{sec:org0edb9d0}
\begin{enumerate}
\item Monousuarios
\label{sec:org9141db9}
...
\label{sec:orgfc639aa}
\begin{enumerate}
\item Debian
\label{sec:org78ce0e6}
\begin{center}
